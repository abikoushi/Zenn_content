...
公平なコイントスのモデル, 確率パラメータ0.5の二項分布を使ってp値を計算してみる.
...
さて, できれば二項分布以外のモデルも含めた一般の場合で検定統計量の見つけ方を知れると嬉しい. そこで, 次の「尤度を使った方法」で本題の尤度比検定, ワルド検定, スコア検定から定まる信頼区間を計算していく.
