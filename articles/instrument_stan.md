...
次のように， $U$ から独立で $X$ のみに影響を与える都合のいい変数 $Z$ が観測されていたとすると識別可能になる．
...
この記事でもそれを踏襲してみたが，どうだろうか．類似の記事に [Stan ユーザーのための層別解析入門の準備](https://zenn.dev/abe2/articles/stratified_stan) がある．
...
R から Stan を動かしたコードは以下に置く：

https://github.com/abikoushi/Zenn_content/blob/main/R/instrument_stan.R

冒頭の有向非巡回グラフの図を描いたコードは以下に置く：

https://gist.github.com/abikoushi/520ae7e8eddcf711099f998491436daa
