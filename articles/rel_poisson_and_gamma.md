...
例えば，時間 $T$ あたりのポンプの故障回数とか，面積 $T$ あたり松の木の本数とかを扱うとき，それぞれ時間や面積との比 $r$ をパラメータとしたいが上限が明確にはわからない．
...
また，ここで述べたことと非常によく似た関係が，二項分布とベータ分布についても成立する．[二項分布とベータ分布の関係+α](https://zenn.dev/abe2/articles/rel_binom_and_beta) に書いた．
